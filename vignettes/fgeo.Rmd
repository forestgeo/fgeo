...
The `habitats` column results from a cluster analysis of three variables computed from the elevation dataset: mean elevation, convexity and slope.

```{r}
cluster_elevation(luquillo_elevation, gridsize = 20, n = 4)
```
...
You can visualize the results with `plot()`.
