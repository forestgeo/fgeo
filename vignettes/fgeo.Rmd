...
## Mapping the distrubution of tree species
...
## Determine species-habitat assiciations
...
`recruitment()`, `mortality()` and `growth()` work similarly. The first and second input are the earlier and later censuses you want to analyse demography on.
