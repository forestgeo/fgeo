...
You may suppress the startup message with `suppressPackageStartupMessages()` or add  `options("fgeo.quiet" = TRUE)` to .Rprofile (see [`usethis::edit_r_profile()`](https://usethis.r-lib.org/reference/edit.html)).
