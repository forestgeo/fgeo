---
title: "fgeo 1.0.0 release candidate"
author: Mauro Lepore
date: "`r Sys.Date()`"
...
[__fgeo__](https://forestgeo.github.io/fgeo/index.html) is a collection of R packages to analyze forest diversity and dynamics. Its first release is planned for February 2019. Before that, we would love you to [give us some feedback, and report issues](https://github.com/forestgeo/fgeo/issues).

This post highlights the major features. For more details please see the [Example](https://forestgeo.github.io/fgeo/index.html#example) and [Reference](https://forestgeo.github.io/fgeo/articles/siteonly/reference.html) sections.
...
Use [`rdata_list()`](https://forestgeo.github.io/fgeo.tool/reference/dir_list) to read multiple censuses at once.
