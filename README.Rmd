...
Data may be made available as required by the journals to enable reproduction of the results. If you wish to publish based on these data you are required to get permission from the Principal Investigators of the corresponding ForestGEO site.
