...
3. Install __devtools__.

``` r
install.packages("devtools")
```

4.a. Install __fgeo__ directly from GitHub with:

```R
devtools::install_github("forestgeo/fgeo")
```

4.b. Or install __fgeo__ with some help:
...
If you need more help, try these [detailed instructions](https://forestgeo.github.io/fgeo/articles/siteonly/questions-and-answers.html#how-can-i-troubleshoot-the-installation-from-github).
