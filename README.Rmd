...
* Try the helper package [__fgeo.install__](https://github.com/forestgeo/fgeo.install#fgeoinstall).

* Try more [detailed instructions](https://forestgeo.github.io/fgeo/articles/siteonly/questions-and-answers.html#how-can-i-troubleshoot-the-installation-from-github).
