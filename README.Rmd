...
With this setup you can also update all __fgeo__ packages with `update.packages()`. To remove packages see [`remove.packages()`](https://www.rdocumentation.org/packages/utils/versions/3.5.2/topics/remove.packages), for example, `remove.packages(c("fgeo.plot", "fgeo.analyze"))`.
