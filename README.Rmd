...
__fgeo__ installs and loads multiple R packages, functions and datasets to visualize trees and analyze their abundance, demography, and habitats. It includes general-purpose functions to simplify the manipulation and visualization of ForestGEO datasets.
