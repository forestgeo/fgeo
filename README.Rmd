...
__fgeo__ installs and loads multiple R functions, and datasets to visualize and manipulate ForestGEO datasets, and to analyze trees abundance, demography, and habitats.
...
* [Contact the maintainer](https://github.com/forestgeo/fgeo/issues/new) to ask questions, report bugs, or propose features
...
__Option 1: Install from GitHub__

You need an _authenticated_ GitHub-account (see [`usethis::browse_github_pat()`](https://usethis.r-lib.org/reference/browse_github_pat.html)).
...
knitr::include_graphics("https://i.imgur.com/s1wkAD4.png")
```
