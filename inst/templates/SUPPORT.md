# Getting help with EDIT-PACKAGE-NAME

Thanks for using __EDIT-PACKAGE-NAME__. Before filing an issue, there are a few places to explore and pieces to put together to make the process as smooth as possible.
...
Before opening a new issue, be sure to search [issues](https://github.com/forestgeo/EDIT-PACKAGE-NAME/issues) and [pull requests](https://github.com/forestgeo/EDIT-PACKAGE-NAME/pulls) to make sure the bug hasn't been reported and/or already fixed in the development version. By default, the search will be pre-populated with `is:issue is:open`. You can [edit the qualifiers](https://help.github.com/articles/searching-issues-and-pull-requests/) (e.g. `is:pr`, `is:closed`) as needed. For example, you'd simply remove `is:open` to search _all_ issues in the repo, open or closed.
